...
export default function NewsCard({ item }) {
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-[28px] border border-neutral-100 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <button className="mt-auto pt-6 flex items-center gap-2 font-bold text-[#8f0d0d]">
          Lire
